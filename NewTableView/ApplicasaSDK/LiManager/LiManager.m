...
+ (void) setObjectDictionary{
	...
	[array addObject:[NSDictionary dictionaryWithObject:[CombatAircraft getFields] forKey:[CombatAircraft getClassName]]];
...
+ (void) setForeignKeysDictionary{
	...
	[dic setObject:[CombatAircraft getForeignKeys] forKey:[CombatAircraft getClassName]];
